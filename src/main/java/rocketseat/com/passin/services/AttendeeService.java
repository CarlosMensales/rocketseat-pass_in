...
import rocketseat.com.dto.attendee.AttendeeDetails;
...
public class AttendeeService {
    ...
    public void verifyAttendeeSubscription(String email, String eventId) {
        ...
        if(isAttendeeRegistered.isPresent()) throw new AttendeeAlreadyExistException("Attendee is already Register");
    }
